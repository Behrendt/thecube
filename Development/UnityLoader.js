...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'CubeGit.data';
    var REMOTE_PACKAGE_BASE = 'CubeGit.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 3583806;
      var PACKAGE_UUID = '4c107b63-2e0a-4eba-842e-fcd99ddf8a55';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 246294, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(246294, 246733, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(246733, 250081, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(250081, 2060121, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(2060121, 3556181, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(3556181, 3583806, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_CubeGit.data');

    };
    Module['addRunDependency']('datafile_CubeGit.data');
